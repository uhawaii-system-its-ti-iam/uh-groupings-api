...
public class GroupingsRestControllerv2_1Test {
    ...
    public void getAllMembersTest() throws Exception {
        ...
        given(groupingOwnerService.getAllMembers(TEST_USER, paths, 700, SortBy.NAME.sortString(), true))
                .willReturn(groupingPagedMembers);

        MvcResult result = mockMvc.perform(post(API_BASE + "/groupings/all-members?fetchSize=700&sortBy="
        ...
        verify(groupingOwnerService, times(1))
                .getAllMembers(TEST_USER, paths, 700, SortBy.NAME.sortString(), true);
    }
    ...
    public void startAllMembersProgressTest() throws Exception {
        ...
        MvcResult result = mockMvc.perform(post(API_BASE + "/groupings/all-members/start?fetchSize=700&sortBy="
                        + SortBy.NAME.value() + "&isAscending=true")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(JsonUtil.asJson(paths)))
                .andExpect(status().isAccepted())
    ...
    public void getAllMembersProgressTest() throws Exception {
        ...
        given(groupingOwnerService.getAllMembersProgress(TEST_USER, requestId))
                .willReturn(progress);
        ...
        assertNotNull(result);
        verify(groupingOwnerService, times(1))
                .getAllMembersProgress(TEST_USER, requestId);
    }
    ...
    public void getAllMembersResultTest() throws Exception {
        ...
        given(groupingOwnerService.getAllMembersResult(TEST_USER, requestId))
                .willReturn(groupingPagedMembers);
        ...
        assertNotNull(result);
        verify(groupingOwnerService, times(1))
                .getAllMembersResult(TEST_USER, requestId);
    }
