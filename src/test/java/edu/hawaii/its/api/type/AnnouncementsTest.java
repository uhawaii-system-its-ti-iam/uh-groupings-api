...
class AnnouncementsTest {
    ...
    void setUp() {
        ...
        announcementsList.add(new Announcement("first valid message", start2, end2));
        announcementsList.add(new Announcement("second valid message", start3, end3));
    ...
    void validMessages() {
        ...
        //will fail when time passes the mock data
