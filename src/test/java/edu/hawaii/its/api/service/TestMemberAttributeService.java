...
public class TestMemberAttributeService {
    ...
    public void getUserAttributesTest() {
        ...
        attributes = memberAttributeService.getMemberAttributes("zzzzzz", usernames[1]).getAttributes();
    ...
    public void getOwnedGroupingsTest() {
        ...
        // Test with invalid username
        assertFalse(memberAttributeService.getOwnedGroupings("zzzzzz", usernames[1]).size() > 0);
