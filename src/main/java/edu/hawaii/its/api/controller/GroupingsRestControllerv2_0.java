...
//>>>>>>> master:src/main/java/edu/hawaii/its/api/controller/GroupingsRestControllerv2_0.java
    ...
    public ResponseEntity<GroupingsServiceResult> setListserv(Principal principal, @PathVariable String grouping,
        ...
        return ResponseEntity
                .ok()
                .body(groupAttributeService.changeListservStatus(grouping, principal.getName(), isListservOn));
    }
    ...
    public ResponseEntity<List<GroupingsServiceResult>> setOptIn(Principal principal, @PathVariable String grouping,
        ...
        return ResponseEntity
                .ok()
                .body(groupAttributeService.changeOptInStatus(grouping, principal.getName(), isOptInOn));
    }
    ...
    public ResponseEntity<List<GroupingsServiceResult>> setOptOut(Principal principal, @PathVariable String grouping,
        ...
        return ResponseEntity
                .ok()
                .body(groupAttributeService.changeOptOutStatus(grouping, principal.getName(), isOptOutOn));
    }
